...
INSERT INTO public.alerts (user_id, student_id, student_name, course, latitude, longitude, status, created_at) VALUES
...
(5, '2024001236', 'Airton Maia', 'Direito', -23.549800, -46.632500, 'resolved', NOW() - INTERVAL '3 days')
